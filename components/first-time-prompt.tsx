      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid grid-cols-1 gap-4 py-4 sm:grid-cols-2">
          ...
          >
            ...
            <span className="text-xs text-center text-muted-foreground px-1">Data stored on this device only</span>
          </Button>
          <Button
            variant="outline"
            className="flex flex-col items-center justify-center h-32 p-4 gap-2"
          ...
          >
            ...
            <span className="text-xs text-center text-muted-foreground px-1">Cloud backup and multi-device access</span>
          </Button>
        </div>
