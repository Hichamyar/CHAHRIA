  ...
  const handleDataLocationChange = (location: "local" | "google") => {
    if (location === "google") {
      toast({
        ...
        description:
          "This feature is not functional in this demo. In a real app, this would connect to Google for authentication and data syncing.",
        duration: 5000,
      })
    }
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-muted-foreground">Data stored on this device only</div>
                  </div>
                </Button>
                <Button
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-muted-foreground">Cloud backup (demo only)</div>
                  </div>
                </Button>
              </div>
              {settings.dataLocation === "google" && (
                <p className="text-xs text-muted-foreground mt-2">
                  Note: Google integration is not functional in this demo. In a real app, this would connect to Google
                  for authentication and data syncing.
                </p>
              )}
            </CardContent>
          </Card>
